...
{
    public class BitBufferOptionsOrig : IEquatable<BitBufferOptionsOrig>
    {
        public static readonly BitBufferOptionsOrig Default = new BitBufferOptionsOrig(charSpanBitsLength: DefaultCharSpanBitsLength, u8SpanBitsLength: DefaultU8SpanBitsLength);
        ...
        public BitBufferOptionsOrig(i32 charSpanBitsLength = DefaultCharSpanBitsLength, i32 u8SpanBitsLength = DefaultU8SpanBitsLength)
        {
            // one time setup
        ...
        public bool Equals(BitBufferOptionsOrig other) => 
