...
namespace NetStack.Serialization
{
    ...
    public partial struct MemoryBufferWriter<T> 
    {
        ...
        public MemoryBufferWriter(i32 capacity = DefaultCapacityUInt, BitBufferOptions config = default)
        ...
        public MemoryBufferWriter(u32[] buffer, BitBufferOptions config = default)
        {
